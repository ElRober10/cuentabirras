// Prefijo internacional (sin el "+") de cada país, por su código ISO
// 3166-1 alpha-2 (el mismo formato que devuelve
// `Location.reverseGeocodeAsync(...).isoCountryCode` de expo-location). Se
// usa solo para adivinar el prefijo de un número de teléfono que no trae
// ninguno — ver application/invitations/normalizePhoneWithCountryCode.js.
export const COUNTRY_CALLING_CODES = {
  AD: '376', AE: '971', AF: '93', AG: '1', AI: '1', AL: '355', AM: '374', AO: '244',
  AR: '54', AS: '1', AT: '43', AU: '61', AW: '297', AZ: '994',
  BA: '387', BB: '1', BD: '880', BE: '32', BF: '226', BG: '359', BH: '973', BI: '257',
  BJ: '229', BM: '1', BN: '673', BO: '591', BR: '55', BS: '1', BT: '975', BW: '267',
  BY: '375', BZ: '501',
  CA: '1', CD: '243', CF: '236', CG: '242', CH: '41', CI: '225', CK: '682', CL: '56',
  CM: '237', CN: '86', CO: '57', CR: '506', CU: '53', CV: '238', CY: '357', CZ: '420',
  ...
  MA: '212', MC: '377', MD: '373', ME: '382', MG: '261', MH: '692', MK: '389', ML: '223',
  MM: '95', MN: '976', MO: '853', MP: '1', MQ: '596', MR: '222', MS: '1', MT: '356',
