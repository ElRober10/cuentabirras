 ...
 * @property {(barIds: string[]) => Promise<Record<string, string>>} getSignedUrlsForBars - Igual que getSignedUrlForBar pero para varios bares a la vez, en dos peticiones en total (no una cadena por bar) — pensado para listas. Devuelve un mapa barId -> url; los bares sin foto (propia ni oficial) no aparecen en el mapa.
